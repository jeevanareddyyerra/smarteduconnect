  ...
  const notifications = [
    {
      ...
      text: "CS201 assignment due tomorrow",
      time: "2 hours ago",
    },
    {
      title: "Exam Scheduled",
      text: "Midterm exam for CS301 on Friday",
      time: "1 day ago",
    },
  ];
            ...
            <div className="dbCard">
              ...
              <div className="dbMiniStats">
                <div className="dbMini">
                  ...
                  <div className="dbMiniLbl">Course Progress</div>
                </div>
                <div className="dbMini">
                  <div className="dbMiniPct">60%</div>
                  <div className="dbMiniLbl">Assignment Progress</div>
                </div>
              </div>
            </div>
          </div>
